...
| PowerShell                       | Azure, PowerShell Core             | Automation, Scripting, Cloud Mgmt   |
| JavaScript                       | Node.js, React                     | Web Dev, Front-end Dev, Server-side |
| SPL (Splunk Search Processing Language) | Splunk Platform                    | Log Data Analysis, Reporting, Viz.  |
{:data-align="center"}

### Query Languages
| Language                        | Platform/Tool                     | Use Cases                          |
|:---------------------------------|------------------------------------:|:----------------------------------|
| KQL (Kusto Query Language)      | Azure Synapse, Power BI            | Data Analysis, Querying, BI        |
